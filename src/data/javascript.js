export const algoritmo = "Un algoritmo es una secuencia de pasos lógicos y ordenados que se utilizan para resolver un problema o realizar una tarea específica. " +
...
export const pseudoCodigo = "El pseudocódigo es una forma de escribir algoritmos utilizando un lenguaje simple y no específico, es un intermedio entre el lenguaje humano "+
...
export const diagramaFlujo = "Un diagrama de flujo es una representación gráfica de un proceso, algoritmo o sistema, que utiliza diferentes símbolos para mostrar las diferentes etapas,"+
...
export const variable = "En programación, las variables son como cajas de almacenamiento donde podemos guardar diferentes cosas. Cada caja tiene un nombre y puede contener un valor"+
...
export const almacenamientoRam = "El almacenamiento en la memoria RAM es volátil. Esto significa que, al igual que cuando apagas una computadora, cuando finaliza un programa,"+
" toda la informacion almacenada en las variables desaparece, es como vaciar todas las cajas y perdiéramos su contenido."

export const typeVar = "var fue la forma original de declarar variables en JavaScript. Las variables declaradas con var tienen un ámbito de función, lo que significa que están" +
...
export const typeLet = "let fue introducido en ECMAScript 6 (ES2015) como una alternativa a var. Las variables declaradas con let tienen un alcance de bloque, lo que significa que solo están disponibles dentro del bloque en el que se declaran."+ 
" Además, las variables let no pueden ser redeclaradas en el mismo ámbito, pero sí pueden ser reasignadas."

export const typeConst = "const también fue introducido en ES6 y se utiliza para declarar variables cuyo valor no cambiará a lo largo del tiempo. Las variables declaradas" +
...
export const primitivos = "Los tipos de datos primitivos se llaman así debido a que son los bloques de construcción básicos y fundamentales en un lenguaje de programación."+
" Son los tipos de datos más simples que no pueden descomponerse en partes más pequeñas"

export const tiposPrimitivos = [
  {
    type: "Number",
...
export const noPrimitivos = "Los tipos de datos no primitivos, son estructuras de datos más complejas que pueden contener múltiples valores y propiedades, los tipos de datos primitivos"+
" representan valores individuales y no tienen métodos o funcionalidades adicionales asociadas."

export const tiposNoPrimitivos = [
  {
    type: "Object",
...
export const scope = "En JavaScript, el scope (alcance) se refiere a la visibilidad y accesibilidad de las variables, funciones y objetos en una parte específica del código durante" +
...
export const hoisting = "El hoisting en JavaScript es un comportamiento que ocurre durante la fase de compilación o interpretación del código. Consiste en el movimiento de las"+
...
export const operadores = "Los operadores son elementos fundamentales en la programación, ya que nos permiten realizar diferentes tipos de cálculos y manipular datos."+
" Estos son: aritméticos, de asignación, comparación y lógicos"

export const expresiones = "Una expresión regular en programación es una secuencia de caracteres que define un patrón de búsqueda. Se utiliza para buscar"+
...
export const ifElse = "El condicional if...else permite ejecutar un bloque de código si se cumple una condición, y otro bloque de código si la condición no se cumple."

export const switchDef = "switch es una estructura de control que permite evaluar una expresión y ejecutar diferentes bloques de código dependiendo del valor de la expresión."

export const forDef = "for es un ciclo que se utiliza para repetir un bloque de código un número específico de veces."

export const whileDef = "while es un ciclo que se ejecuta mientras una condición específica sea verdadera."

export const doWhile = "do...while es similar a while, pero garantiza que el bloque de código se ejecute al menos una vez, incluso si la condición es falsa desde el principio."

export const arrayDef = "Un array en JavaScript es una estructura de datos que permite almacenar y organizar múltiples valores en una sola variable. Es una colección" +
...
export const indiceArray = "Los índices de un array son números enteros que se utilizan para identificar y acceder a elementos individuales dentro del array."+
...
export const stack = "El stack es una región de memoria que se utiliza para almacenar datos en un orden estructurado conocido como (pila). En esta pila, se almacenan" +
...
export const heap = "El heap es otra región de memoria utilizada para almacenar datos más grandes y complejos, como objetos y arreglos en JavaScript. A diferencia del stack," +
...
export const forEach = "Itera sobre cada elemento de un array y ejecuta una función para cada uno de ellos."

export const map = "Crea un nuevo array con los resultados de llamar a una función proporcionada en cada elemento del array original."

export const reduce = "Aplica una función a un acumulador y a cada valor del array (de izquierda a derecha) para reducirlo a un único valor."

export const filter = "Crea un nuevo array con todos los elementos que pasan la prueba implementada por la función proporcionada."

export const some = "Comprueba si al menos un elemento del array cumple con la condición implementada por la función proporcionada."

export const otrosMetodos = "Estos son solo algunos de los métodos más comunes de los arrays en JavaScript. Hay muchos otros métodos útiles que puedes explorar, como" +
...
export const funciones = "En programación, una función es un bloque de código que realiza una tarea específica. Es una forma de organizar y reutilizar el código al" +
" encapsular un conjunto de instrucciones bajo un nombre descriptivo."

export const difFunAndArrow = [
...
export const funcionesAnonimas = "Una función anónima en JavaScript es una función que no tiene un nombre específico asociado a ella, es decir, se define directamente en el"+
...
export const recursividad = "La recursividad es un concepto en programación que implica que una función se llame a sí misma. Es importante tener en cuenta que las funciones"+
...
export const excepciones = "En programación, las excepciones son eventos inusuales o condiciones de error que ocurren durante la ejecución de un programa y que pueden" +
...
export const excepciones2 = "Las excepciones pueden ser causadas por diversos factores, como errores de sintaxis, operaciones matemáticas inválidas, manipulación incorrecta de"+
...
export const sincronia = "En un enfoque sincrónico, las tareas se ejecutan de manera secuencial, una después de la otra. Cada tarea debe esperar a que la tarea"+
...
export const asincronia = "En un enfoque asincrónico, las tareas no se ejecutan de manera secuencial. En lugar de esperar a que una tarea se complete antes de pasar a la"+
...
export const callback = "Un callback en JavaScript es una función que se pasa como argumento a otra función y que se ejecuta después de que cierta operación asincrónica" +
...
export const promesas = "Las promesas en JavaScript son objetos que representan la eventual finalización (o falla) de una operación asincrónica y su valor resultante." +
...
export const promiseAll = "toma un iterable de promesas como entrada y devuelve una única promesa que se resuelve cuando todas las promesas en el iterable se han resuelto, o se"+ 
...
export const promiseRace = "toma un iterable de promesas como entrada y devuelve una única promesa que se resuelve o se rechaza tan pronto como una de las promesas del iterable"+ 
" se resuelve o se rechaza, con el valor o motivo de esa primera promesa resuelta o rechazada."

export const promiseSettled = " toma un iterable de promesas como entrada y devuelve una única promesa que se resuelve después de que todas las promesas en el iterable se han"+ 
" resuelto o rechazado, cada una con un objeto que describe el resultado de cada promesa."

export const asyncAwait = "async y await son características introducidas en ECMAScript 2017 (también conocido como ES8) que simplifican el trabajo con promesas y hacen que el código asincrónico sea más legible y fácil de entender."

export const asyncDef = "La palabra clave async se utiliza para declarar que una función retornará una promesa. Una función async automáticamente envuelve su valor de retorno en una promesa resuelta."

export const awaitDef = "La palabra clave await se utiliza para esperar a que una promesa se resuelva o se rechace. Solo se puede usar dentro de una función async. El uso de await pausa la ejecución"+ 
" de la función async hasta que la promesa se resuelva."

export const asyncAwait2 = "La combinación de async y await hace que el código asincrónico sea más fácil de leer y escribir, especialmente en comparación con el uso de callbacks o cadenas de promesas encadenadas."+
